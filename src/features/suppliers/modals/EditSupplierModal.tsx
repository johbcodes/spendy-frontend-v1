  ...
  useEffect(() => {
    if (supplier) {
      setFormData({
        ...
        servicesProvided: Array.isArray(supplier.servicesProvided) && supplier.servicesProvided.length > 0
          ? supplier.servicesProvided
          : [],
        paymentMethod: supplier.paymentMethod || 'Mpesa B2C',
      ...
      setUploadedDocuments(supplier.documents || []);
    }
  }, [supplier]);
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <Select
          ...
          options={[
            ...
            ...supplierCategories.map(cat => ({ value: cat.name, label: cat.name }))
          ]}
        ...
        <div>
          <label className="block text-sm font-medium text-dark-gray mb-2">
            Services Provided & Typical Costs (Optional)
          </label>
        ...
        <Select
          ...
          options={[
            { value: 'Mpesa B2C', label: 'M-Pesa Send Money (B2C)' },
            { value: 'Paybill B2B', label: 'M-Pesa Paybill (B2B)' },
            { value: 'Till B2B', label: 'M-Pesa Till Number (B2B)' },
        ...
        <div>
          ...
          <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
            <input
              ...
              className="hidden"
              id="supplier-documents-edit"
            />
            <label htmlFor="supplier-documents-edit" className="cursor-pointer">
